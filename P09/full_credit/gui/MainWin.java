...
public class MainWin extends JFrame
{
 ...
 public Mainwin(String mainWindowTitle)
 {
  ...
  mCustomer.addActionListener(event -> onNewCustomerClick());
  mProducts.addActionListener(event -> updateDisplay());
  Customers.addActionListener(event -> updateDisplay());
  ...
  setJMenuBar(menubar);
        ...
        bProducts = new JButton(new ImageIcon("gui/resources/Orders.png"));
          bProducts.setActionCommand("list of current orders");
          bProducts.setToolTipText("Shows a list of the current orders placed");
          toolbar.add(bProducts);
          bProducts.addActionListener(event -> updateDisplay());
          
        bCustomers = new JButton(new ImageIcon("gui/resources/Customers.png"));
          bCustomers.setActionCommand("list of current customers");
          bCustomers.setToolTipText("Shows a list of the current customers ordering");
          toolbar.add(bCustomers);
          bCustomers.addActionListener(event -> updateDisplay());
          
        bCustomer = new JButton(new ImageIcon("gui/resources/Customer.png");
          bCustomer.setActionCommand("create a new customer");
          bCustomer.setToolTipText("creates a new customer in order to start the order");
          toolbar.add(bCustomer);
          bCustomer.addActionListener(event -> onNewCustomerClick());
 ...
 protected void onAboutClick()
 {
  ...
  about.add(title);
  JLabel artist = new JLabel("<html>" + "<p>Version 1.3J</p>" + "<p>Copyright 2017-2020 by Chau-Phuc Nguyen</p>" + "<p>Licensed under Gnu GPL 3.0</p>" + "<p>Logo by Chau-Phuc Nguyen, for personal use</p>" + "<p>Coffee Cup Icon by Chau-Phuc Nguyen, for personal use</p>" + "<p>Donut Icon by Chau-Phuc Nguyen, for personal use</p>" + "<p>About Icon by Chau-Phuc Nguyen, for personal use</p>" + "<p>New Icon by Chau-Phuc Nguyen, for personal use</p>" + "<p>Open Icon by Chau-Phuc Nguyen, for personal use</p>" + "<p>Save Icon by Chau-Phuc Nguyen, for personal use</p>" + "<p>Save As Icon by Chau-Phuc Nguyen, for personal use</p>" + "<p>Customers Icon by Chau-Phuc Nguyen, for personal use</p>" + "</p>Orders Icon by Chau-Phuc Nguyen, for personal use</p>" + "</p>New Customer Icon by Chau-Phuc Nguyen, for personal use</p>"+ "</html>");
  about.add(artist);
