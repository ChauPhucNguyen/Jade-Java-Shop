...
{   
 ...
 {
  return name + " (" + ((frosting != Frosting.Unfrosted) ? "frosted with " : "") + frosting + ((filling != Filling.Unfilled) ? " filled with " : " ") + filling + ((sprinkles) ? " add sprinkles" : "") + ") $" + price;
 }
 ...
 public boolean equals(Object o)
 {
  ...
  Donut p = (Donut) o;
  return super.equals((Product) p) && (frosting == p.frosting) && (filling == p.filling) && (sprinkles == p.sprinkles);
 }
 ...
 public int hashCode()
 {
  ...
  hash = 31*hash + (sprinkles ? 7177 : 7717);
  return hash;
 }
